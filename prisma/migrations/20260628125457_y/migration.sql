/*
  ...
  - The values [ADMIN] on the enum `ActiveStatus` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "ActiveStatus_new" AS ENUM ('ACTIVE', 'BLOCEKD');
